...
from qkd.generate_t22_key import quantum_compute
from qkd.generate_t22_key import generate_code
from qkd.generate_bb84_key import bb84_qkd_protocol
from qkd.generate_e91_key import e91_qkd_protocol
import random
import time
...
async def get_bb84_key(desired_key_length: int):
    if desired_key_length <= 0:
        raise HTTPException(status_code=400, detail="Number of bits must be positive")
